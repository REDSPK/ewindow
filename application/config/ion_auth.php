...
*/
	 ...
	 */
	$config['site_title']		   = "E-window";
	
	/**
	 * Admin Email, admin@example.com
	 */
	$config['admin_email']		   = "sh.faizan.ali@gmail.com";
	
	/**
	 * Default group, use name
	 */
	$config['default_group']       = SHOPPER;
     ...
     * Default : auth/
	 **/
	$config['email_templates']     = 'user/';
	
	/**
	 * activate Account Email Template
     * Default : activate.tpl.php
	 **/
	$config['email_activate']   = 'activate-account';
